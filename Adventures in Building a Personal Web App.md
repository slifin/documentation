...
I will 100% get the schema wrong and will need to change it so I want to keep payload tables immutable and unopinionated about any schema whilst my derived tables can evolve and mutate as need be.
